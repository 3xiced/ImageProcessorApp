...
QImage* Core::Filters::PrewittFilter::applyFilter(Core::FilterSettings* filterSettings)
{
...
QVector<uchar> Core::Filters::PrewittFilter::toGrayscaleBytes(const QImage& image)
{
