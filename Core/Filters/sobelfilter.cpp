...
QImage* Core::Filters::SobelFilter::applyFilter(Core::FilterSettings* filterSettings)
{
...
QVector<uchar> Core::Filters::SobelFilter::toGrayscaleBytes(const QImage& image)
{
